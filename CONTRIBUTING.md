# Contributing to the `OpenSudoku` project
...
Since `OpenSudoku` has very little to do beyond programming and testing,
...
[Issues]: https://github.com/Diapolo10/OpenSudoku/issues
[Projects]: https://github.com/Diapolo10/OpenSudoku/projects
